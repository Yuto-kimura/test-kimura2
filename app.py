        ...
        dcc.Graph(
            ...
            figure={
                ...
                'layout':go.Layout(
                    ...
                    # slideはグラフの右側、左側のどちらのy軸に対応させるか選んだものになっている。
                    # rangeはグラフの幅を求めている。この場合だと、y軸の幅になる。
                    yaxis=dict(title='受講生の総数',side='left',showgrid=False,
        ...
        dcc.Graph(
            ...
            figure={
                ...
                'layout':go.Layout(
                    ...
                    # slideはグラフの右側、左側のどちらのy軸に対応させるか選んだものになっている。
                    # rangeはグラフの幅を求めている。この場合だと、y軸の幅になる。
                    yaxis=dict(title='レビュー総数の総数',side='left',showgrid=False,range=[0,max(reviews)+10]),
